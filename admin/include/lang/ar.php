...
function lang($word)
{
    ...
    static $lang = [
    'INVALID_CREDENTIALS' => 'البيانات المقدمة غير صحيحة',
    'REGISTER' => 'تسجيل الدخول لمدير',
    'R_LOGIN' => 'دخول',
    ...
    'USER' => 'مستخدم',
    'ADMIN' => 'مدير',
    'M_C_S_R' => 'يجب اختار دور للمستخدم',
    'EDIT_SUCCESS' => 'تم تعديل البيانات بنجاح',
    'DEL_SUCCESS' => 'تم حذف المستخدم بنجاح',
    'A_Y_D' => 'هل أنت متأكد من رغبتك في حذف هذا المستخدم ومنشوراته نهائياً؟',

    'P_VIEW_PROFILE' => "عرض الملف الشخصي",
    'BTN_EDIT' => 'تعديل',
    'BTN_DELETE' => 'حذف',
    'BTN_CANCEL' => 'الغاء',
    'ID' => 'العدد التعريفي',
