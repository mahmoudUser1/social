        ...
        <div class="col-12 col-lg-7 col-md-6">
            ...
            if ($page == 'home') {
                ...
                <div class="p-2 m-3 card flex-row d-flex justify-content-between align-items-center rounded-5">
                    <h5>هل تريد انشاء post</h5>
                    <a href="?page=addPost" class="btn btn-primary rounded-circle"><i class="fa-solid fa-plus"></i></a>
                </div>
                ...
                if ($posts) {
                    foreach ($posts as $post1) {
                        ...
                        <div class="card  bg-warning bg-opacity-10 p-2 mb-2">
                            ...
                            <div class="post-content m-2 py-2"><?= $post1['content'] ?></div>
                        </div>
                ...
                <div class="card p-3">
                    <form action="?page=addPost" method="post">
                        <textarea class="form-control mb-3" name="post" placeholder="ماذا يدور في ذهنك؟"></textarea>
                ...
                ?>
                <div class="p-2 card flex-row d-flex justify-content-between align-items-center rounded-5">
                    <h5>هل تريد انشاء post</h5>
                    <a href="?page=addPost" class="btn btn-primary rounded-circle"><i class="fa-solid fa-plus"></i></a>
                </div>
