...
// حماية الصفحة: التأكد من أن المستخدم سجل دخوله وفعل حسابه
...
if ($userStatus && $userStatus['is_verified'] == 0) {
...
<div class="row pt-6 p-md-2 m-0">
    ...
    <div class="col-12 col-lg-7 col-md-6">
        ...
        if ($page == 'home') {
            ...
            ?>
            <div class="card p-3 m-3 flex-row d-flex justify-content-between align-items-center rounded-4 shadow-sm">
                <h5 class="mb-0"><?= lang('H_CREATE_POST') ?></h5>
                <a href="?page=addPost"
