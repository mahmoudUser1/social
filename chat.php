...
if (isset($_SESSION["email"])) {
    ...
    <div class="chat-main-container">
        <div class="row m-0 h-100">
            <!-- Left side space (as in the original design) -->
                ...
                fetch(`api/get_messages.php?receiver_id=${activeReceiverId}`)
                    ...
                    .then(messages => {
                        ...
                        if (messages.length === 0) {
                            messagesDisplay.innerHTML = '<div class="h-100 d-flex align-items-center justify-content-center text-muted"> <?= lang('C_NO_MESSAGES') ?> </div>';
                            return;
                        }
